    ...
    <div className="flex justify-between items-center w-full mb-7">
      ...
      <div className="flex justify-between items-center gap-5">
        ...
        <div className="relative">
          <input
            type="search"
            placeholder="Start typing to search groubs & products"
      ...
      <div className="flex justify-between items-center gap-5">
        <div className="hidden md:flex justify-between pl-2 items-center gap-5">
          <div className="">
          ...
          <div className="flex items-center gap-3 cursor-pointer">
            <div className="w-9 h-9">
              <Image
                src="https://s3-managementinvetory.s3.eu-central-1.amazonaws.com/profile.jpg"
                alt="Profile"
                width={50}
                height={50}
            ...
            <span className="font-semibold">Eldin Skenderi</span>
          </div>
        </div>
